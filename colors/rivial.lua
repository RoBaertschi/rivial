-- Name:         rivial
-- Description:  Custom colorscheme by me
-- Author:       Robin Bärtschi <rtmbaertschi007@gmail.com>
-- Maintainer:   Robin Bärtschi <rtmbaertschi007@gmail.com>
-- Website:      https://github.com/RoBaertschi/fennel-nvim
-- License:      Same as this repo
-- Last Updated: 3.11.2025

vim.cmd.highlight('clear')
vim.g.colors_name = 'rivial'
...
hi('Conceal', { fg = 'White', bg = 'DarkGrey', ctermfg = 'White', ctermbg = 'DarkGrey' })
hi('Cursor',       {})
hi('lCursor',      {})
...
hi('Define',         { link = '@RivialFunction' })
hi('Macro',          { link = '@RivialFunction' })
...
hi('@function.macro',             { link = '@RivialFunction' })
...
hi('@attribute.builtin',          { link = 'Keyword' })
...
-- hi('@function',          { link = 'Definition' })
hi('@variable',          { link = 'Identifier' })
hi('@type',              { link = 'Type' })
hi('@type.definition',   { link = 'Definition' })
...
if vim.o.background == 'light' then
    ...
    hi('Comment',          { fg = '#555500', bg = 'LightYellow',          ctermfg = 'DarkBlue' })
    -- hi('Constant',         { fg = 'DarkGreen', bg = 'LightGreen',         ctermfg = 'DarkRed', ctermbg = 'LightGreen' })
    ...
    hi('Delimiter',      { fg = '#AAAAAA' })

    -- Default colors only used with a dark background.
    hi('ColorColumn',      { bg = 'DarkRed',                               ctermbg = 'DarkRed' })
    hi('CursorColumn',     { bg = 'Grey20',                                ctermbg = 'DarkGrey' })
    hi('CursorLine',       { bg = 'Grey20',                                cterm = { underline = true } })
    hi('CursorLineNr',     { fg = 'LightGrey', bold = true, bg = 'Grey20', ctermfg = 'Yellow', cterm = { underline = true } })
    ...
    hi('Pmenu',            { bg = 'DarkBlue',                              ctermfg = 'Black', ctermbg = 'Magenta' })
    hi('PmenuSel',         { bg = 'Magenta',                               ctermfg = 'DarkGrey', ctermbg = 'Black' })
    ...
    -- hi('Comment',          { fg = '#555500', bg = 'LightYellow',          ctermfg = 'DarkBlue' })
    -- hi('Comment',          { fg = 'LightYellow', --[[ bg = '#555500', --]]         ctermfg = 'DarkBlue' })
    hi('Comment',          { fg = "Gray78" })

    -- hi('Constant',         { fg = '#ffa0a0',                               ctermfg = 'Magenta' })
    -- hi('Constant',         { fg = '#00FF00', --[[bg = 'DarkGreen'--]] })
    hi('Constant',         { fg = '#059505' })
